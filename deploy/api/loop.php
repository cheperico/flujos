 ...
 *
 * GET: /api/loop.php
 * Devuelve el contenido de deploy/spec.json con Content-Type application/json.
...
if (!file_exists($spec_path)) {
    ...
    echo json_encode(['error' => 'spec.json no existe. Ejecutar el motor: python scripts/ai_media/loop_db.py --horas 7 16 13 18 --salida deploy/spec.json'], JSON_UNESCAPED_UNICODE);
    exit;
}
