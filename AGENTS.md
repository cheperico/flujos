...
- `python scripts/ai_media/test_motor_loop.py` — 47 asserts del motor de loop (segmentos, cruce nocturno, posición, descarte fuera de arco).
...
| Componente | Riesgo |
|---|---|
| Ollama (localhost) | Bajo — la request puede colgar hasta el timeout (120s) |
