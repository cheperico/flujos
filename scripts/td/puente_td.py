...
Uso básico:
  python scripts/td/puente_td.py enviar              # loop completo
  python scripts/td/puente_td.py colores              # solo lista de colores
  python scripts/td/puente_td.py enviar_imgs rojo     # 10 imágenes rojas
  python scripts/td/puente_td.py nube                 # nube de tags
  python scripts/td/puente_td.py elecciones           # nubes de elecciones
  python scripts/td/puente_td.py elecciones --grupo horas,tags
  python scripts/td/puente_td.py fluir                # escucha continua del "Fluir"
"""
...
# elecciones.py vive en scripts/td/ (misma carpeta que este script)
...
Ejemplos:
  python scripts/td/puente_td.py enviar              # loop completo
  python scripts/td/puente_td.py colores              # solo lista de colores
  python scripts/td/puente_td.py enviar_imgs rojo     # 10 rojas
  python scripts/td/puente_td.py enviar_imgs azul --cant 5
  python scripts/td/puente_td.py nube                 # nube de tags
  python scripts/td/puente_td.py nube --max-tags 60   # mas palabras en la nube
  python scripts/td/puente_td.py fluir                # escucha continua del "Fluir"
