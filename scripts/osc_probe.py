...
Uso:
    python scripts/osc_probe.py              # escucha en 9001
    python scripts/osc_probe.py 9001 60      # puerto + segundos de ventana
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog="""Ejemplos:
  python scripts/osc_probe.py            # escucha en 9001 (TD -> Python)
  python scripts/osc_probe.py 9001 60    # 60 segundos de ventana
        """,
    )
